...
import uz.pdp.city_management_monolith.service.apartment.FlatService;
...
public class FlatController {
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> setOwner(
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> removeOwner(
            @PathVariable UUID flatId
    ) {
        return ResponseEntity.ok(uz.pdp.city_management_monolith.domain.dto.response.ApiResponse.builder()
                .message("OK")
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> getByAccommodationId(
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/get/{id}")
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> getFlat(
            @PathVariable UUID id
    ) {
        return ResponseEntity.ok(uz.pdp.city_management_monolith.domain.dto.response.ApiResponse.builder()
                .message("OK")
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/gt")
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> getMine(
            @RequestBody(required = false) Filter filter,
            Principal principal
    ) {
        return ResponseEntity.ok(uz.pdp.city_management_monolith.domain.dto.response.ApiResponse.builder()
