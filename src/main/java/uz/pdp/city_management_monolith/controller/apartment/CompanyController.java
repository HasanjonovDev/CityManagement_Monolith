...
import uz.pdp.city_management_monolith.service.apartment.CompanyService;
...
public class CompanyController {
     ...
     * @throws uz.pdp.city_management_monolith.exception.DataNotFoundException when user is not found and when card is not found
     */
    @ApiResponse(
            headers = @Header(
                    name = "authorization",
    ...
    @PostMapping("/add")
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> add(
            Principal principal,
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> getList(
