...
public class UserController {
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> blockUser(
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> unblockUser(
            @PathVariable UUID userId
    ) {
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> changeName(
            Principal principal,
