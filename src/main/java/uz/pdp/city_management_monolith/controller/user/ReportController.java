...
import uz.pdp.city_management_monolith.service.report.ReportService;
...
public class ReportController {
    ...
    public ResponseEntity<uz.pdp.city_management_monolith.domain.dto.response.ApiResponse> weekReport(
