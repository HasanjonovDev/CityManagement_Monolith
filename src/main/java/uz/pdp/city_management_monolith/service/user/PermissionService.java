...
import uz.pdp.city_management_monolith.domain.dto.user.EditPermissionDto;
import uz.pdp.city_management_monolith.domain.dto.user.PermissionCreateDto;
import uz.pdp.city_management_monolith.domain.dto.user.PermissionsForUserDto;
...
import uz.pdp.city_management_monolith.repository.user.PermissionRepository;
import uz.pdp.city_management_monolith.repository.user.RoleRepositoryImpl;
