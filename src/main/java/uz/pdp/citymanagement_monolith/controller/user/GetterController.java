...
public class GetterController {
    ...
    public ResponseEntity<uz.pdp.citymanagement_monolith.domain.dto.response.ApiResponse> getUser(
    ...
    @GetMapping("/details")
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<uz.pdp.citymanagement_monolith.domain.dto.response.ApiResponse> details(
            @RequestParam UUID id
    ) {
        return ResponseEntity.ok(uz.pdp.citymanagement_monolith.domain.dto.response.ApiResponse.builder()
                .message("OK")
